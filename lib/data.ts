...
export const tours: Tour[] = [
  ...
  // Cruises
  {
    ...
    title: "Sunset Dinner Cruise on the Mandovi",
    ...
    badge: "Bestseller",
    description:
      "Cruise down the Mandovi river at golden hour with live music, cultural performances, a buffet dinner and stunning views of Panaji's skyline.",
    highlights: [
      "Buffet dinner on board",
      "Live music, DJ & cultural show",
      "Panoramic sunset river views",
      "Family & couple friendly",
    ],
    inclusions: ["Cruise ticket", "Buffet dinner", "Onboard entertainment", ...genInclusions.slice(0, 1)],
    exclusions: genExclusions,
  },
  {
    slug: "private-yacht-cruise",
    title: "Private Yacht Cruise Experience",
    categorySlug: "cruises",
    category: "Cruises",
    ...
    badge: "Luxury",
    description:
      "A private luxury yacht chartered just for your group — sail the calm waters of Goa with refreshments, music and complete privacy.",
    highlights: [
      "Exclusive private yacht charter",
      "Refreshments & music on board",
      "Perfect for celebrations",
      "Great for photos & sunsets",
    ],
    inclusions: ["Private yacht for up to 10 guests", "Captain & crew", "Soft beverages", ...genInclusions.slice(0, 1)],
    exclusions: genExclusions,
  },
  // Scuba
  {
