...
export const categories: Category[] = [
  ...
  },
  {
    ...
    image: asset("/dudhsagar-railway-bridge.jpg"),
  },
  {
    slug: "adventure",
    name: "Adventure",
...
export const tours: Tour[] = [
  ...
  {
    slug: "palolem-beach-overnight",
    title: "Palolem Beach Overnight Package",
    categorySlug: "packages",
    category: "Tour Packages",
    ...
    priceOnRequest: true,
    priceUnit: "couple / night",
    image: asset("/palolem-beach-cottages.jpg"),
    // Photos arranged in the client's serial order (01–24):
    // beachfront cottages, beach & shacks, sunsets, a secluded-cove boat
    // trip, welcome drinks, a candlelight beach dinner and evening bonfire.
    gallery: [
      asset("/palolem-yellow-cottages.jpg"),
      asset("/palolem-wooden-huts.jpg"),
      asset("/palolem-wooden-huts-row.jpg"),
      asset("/palolem-beach-shack-view.jpg"),
      asset("/palolem-beach-panorama.jpg"),
      asset("/palolem-sunset-shack.jpg"),
      asset("/palolem-beach-watersports.jpg"),
      asset("/palolem-rocky-cove.jpg"),
      asset("/palolem-clear-shore.jpg"),
      asset("/palolem-welcome-drinks.jpg"),
      asset("/palolem-sunset-pink.jpg"),
      asset("/palolem-beach-day.jpg"),
      asset("/palolem-beach-loungers.jpg"),
      asset("/palolem-cove-boat.jpg"),
      asset("/palolem-shack-seating.jpg"),
      asset("/palolem-sunset-dining.jpg"),
      asset("/palolem-shack-daybed.jpg"),
      asset("/palolem-beach-lunch.jpg"),
      asset("/palolem-beach-bonfire.jpg"),
      asset("/palolem-candlelit-dinner.jpg"),
      asset("/palolem-dinner-plate.jpg"),
      asset("/palolem-shack-night.jpg"),
      asset("/palolem-beach-meal.jpg"),
    ],
    badge: "Beachfront Stay",
    specs: [
      { label: "Stay", value: "Beachfront Cottage · 1 Night" },
      { label: "Occupancy", value: "Per Couple · Per Room" },
      { label: "Location", value: "Right on Palolem Beach" },
      { label: "Highlight", value: "Candlelight Beach Dinner" },
    ],
    description:
      "Fall asleep to the sound of the waves at Palolem — one of South Goa's prettiest beaches. This overnight escape puts you in a cosy beachfront cottage just steps from the sand, with time to soak up golden sunsets, laze at the beach shacks, enjoy a candlelight dinner by the sea and unwind around an evening bonfire. Pricing and exact inclusions are shared on request — tell us your dates and we'll tailor the stay for you.",
    highlights: [
      "Beachfront cottage steps from Palolem Beach",
      "Golden sunsets and relaxed beach-shack lounging",
      "Candlelight dinner by the sea",
      "Evening beach bonfire and calm morning swims",
    ],
    inclusions: [
      "Overnight stay in a beachfront cottage (per couple)",
      "Beach shack access with sun loungers & umbrellas",
      "Candlelight beach dinner",
      "Evening beach bonfire (weather permitting)",
    ],
    exclusions: [
      "Transfers to & from Palolem (on request)",
      "Meals not specified in your package",
      "Water sports & boat trips (payable directly)",
      "Personal expenses, tips & anything not mentioned",
    ],
  },
  {
  ...
  },
  {
    ...
    reviews: 121,
    price: 400,
    image: asset("/old-goa-basilica.jpg"),
    gallery: [
      asset("/old-goa-basilica-visitors.jpg"),
      asset("/old-goa-basilica-facade.jpg"),
      asset("/old-goa-se-cathedral.jpg"),
      asset("/old-goa-se-cathedral-tower.jpg"),
      asset("/old-goa-st-augustine-tower.jpg"),
      asset("/mangueshi-temple.jpg"),
      asset("/fontainhas-alley.jpg"),
      asset("/fontainhas-street.jpg"),
      asset("/panjim-immaculate-conception.jpg"),
      asset("/miramar-beach-panaji.jpg"),
    ],
    description:
  ...
  },
  {
    ...
    reviews: 133,
    price: 400,
    image: asset("/fort-aguada.jpg"),
    gallery: [
      asset("/fort-aguada-lighthouse.jpg"),
      asset("/fort-aguada-ramparts.jpg"),
      asset("/fort-aguada-gateway.jpg"),
      asset("/sinquerim-fort-sea.jpg"),
      asset("/chapora-fort.jpg"),
      asset("/chapora-hill-trail.jpg"),
      asset("/candolim-beach.jpg"),
      asset("/calangute-beach.jpg"),
      asset("/baga-beach.jpg"),
      asset("/anjuna-beach.jpg"),
      asset("/vagator-beach.jpg"),
    ],
    badge: "Bestseller",
    description:
  ...
  },
  {
    ...
    price: 0,
    priceOnRequest: true,
    image: asset("/butterfly-beach.jpg"),
    gallery: [
      asset("/palolem-beach.jpg"),
      asset("/palolem-aerial-sunset.jpg"),
      asset("/palolem-monkey-island.jpg"),
      asset("/butterfly-beach-cove.jpg"),
      asset("/butterfly-beach-aerial.jpg"),
      asset("/agonda-beach-sunset.jpg"),
      asset("/agonda-beach-aerial.jpg"),
      asset("/cabo-de-rama.jpg"),
      asset("/south-goa-kayaks.jpg"),
      asset("/colva-beach.jpg"),
      asset("/betalbatim-sunset.jpg"),
    ],
    badge: "Private Tour",
    description:
  ...
  },
  {
    ...
    reviews: 190,
    price: 1599,
    image: asset("/dolphin-pair-surface.jpg"),
    gallery: [
      asset("/dolphin-goa-boats.jpg"),
      asset("/dolphin-headland.jpg"),
      asset("/dolphin-leap-openocean.jpg"),
      asset("/dolphin-two-surfacing.jpg"),
      asset("/dolphin-pod-surfacing.jpg"),
      asset("/dolphin-common-closeup.jpg"),
      asset("/dolphin-dawn-pod.jpg"),
      asset("/dolphin-head-above-water.jpg"),
      asset("/dolphin-pod-leaping.jpg"),
    ],
    description:
  ...
  },
  {
    ...
    gallery: [
      ...
      asset("/fishing-reels-lineup.jpg"),
      asset("/fishing-catch-on-line.jpg"),
      asset("/fishing-boat-blue-water.jpg"),
    ],
    specs: [
  ...
  },
  {
    ...
    reviews: 96,
    price: 2999,
    image: asset("/snorkel-reef-pair.jpg"),
    gallery: [
      asset("/grand-island.jpg"),
      asset("/snorkel-solo-turquoise.jpg"),
      asset("/snorkel-couple-blue.jpg"),
      asset("/snorkel-group-aerial.jpg"),
      asset("/snorkel-trio-aerial.jpg"),
      asset("/snorkel-tropical-fish.jpg"),
      asset("/snorkel-bubbles.jpg"),
      asset("/snorkel-reef-fish-solo.jpg"),
      asset("/snorkeling-turtle.jpg"),
    ],
    badge: "Full Day",
    description:
  ...
  // Nightlife & Parties
  {
    ...
    gallery: [
      asset("/pubcrawl-club-lights.jpg"),
      asset("/pubcrawl-cocktails-toast.jpg"),
      asset("/pubcrawl-laser-crowd.jpg"),
      asset("/pubcrawl-neon-cocktail.jpg"),
      asset("/pubcrawl-cocktail-closeup.jpg"),
      asset("/pubcrawl-friends-club.jpg"),
      asset("/pubcrawl-crowd-bw.jpg"),
    ],
    badge: "Bestseller",
    description:
  ...
  },
  {
    ...
    price: 3000,
    priceUnit: "couple",
    image: asset("/cubana-pool-laser.jpg"),
    gallery: [
      asset("/cubana-pool-stringlights.jpg"),
      asset("/cubana-openair-festival.jpg"),
      asset("/cubana-neon-crowd.jpg"),
      asset("/cubana-light-beams.jpg"),
      asset("/nightlife-club-cubana.jpg"),
    ],
  ...
  },
  {
    ...
    price: 2500,
    priceUnit: "couple",
    image: asset("/titos-dj-booth.jpg"),
    gallery: [
      asset("/titos-neon-crowd.jpg"),
      asset("/titos-club-scene.jpg"),
      asset("/titos-laser-crowd.jpg"),
      asset("/titos-dancefloor.jpg"),
      asset("/titos-cocktail.jpg"),
      asset("/titos-crowd-bw.jpg"),
      asset("/nightlife-titos.jpg"),
    ],
    specs: [
  ...
  },
  {
    ...
    price: 1000,
    priceUnit: "couple",
    image: asset("/mambos-beach-fireworks.jpg"),
    gallery: [
      asset("/mambos-openair-dj.jpg"),
      asset("/mambos-bonfire-lights.jpg"),
      asset("/mambos-neon-crowd.jpg"),
      asset("/mambos-light-beams.jpg"),
    ],
    specs: [
  ...
  },
  {
    ...
    price: 1000,
    strikePrice: 1600,
    image: asset("/vagator-festival-night.jpg"),
    gallery: [
      asset("/vagator-dj-lasers.jpg"),
      asset("/vagator-led-stage.jpg"),
      asset("/vagator-festival-crowd.jpg"),
      asset("/vagator-neon-crowd.jpg"),
      asset("/vagator-light-beams.jpg"),
      asset("/nightlife-psytrance.jpg"),
    ],
    badge: "Trending",
    description:
  ...
  },
  {
    ...
    price: 900,
    strikePrice: 1400,
    image: asset("/silentnoise-headphones-dusk.jpg"),
    gallery: [
      asset("/silentnoise-crowd-dance.jpg"),
      asset("/silentnoise-multicolor-crowd.jpg"),
      asset("/silentnoise-green-closeup.jpg"),
      asset("/silentnoise-party-crowd.jpg"),
      asset("/silentnoise-two-women.jpg"),
      asset("/silentnoise-led-headphones.jpg"),
    ],
    badge: "Unique",
    description:
  ...
  },
  {
    ...
    price: 5000,
    priceUnit: "couple",
    image: asset("/hammerzz-club-dynamic.jpg"),
    gallery: [
      asset("/hammerzz-neon-crowd.jpg"),
      asset("/hammerzz-light-beams.jpg"),
      asset("/hammerzz-dj-booth.jpg"),
      asset("/hammerzz-lounge.jpg"),
      asset("/hammerzz-cocktail.jpg"),
    ],
    badge: "Luxury",
    specs: [
  ...
  },
  {
    ...
    gallery: [
      ...
      asset("/lpk-waterfront-night.jpg"),
      asset("/lpk-waterfront-deck.jpg"),
      asset("/lpk-crowd.jpg"),
      asset("/lpk-club-dynamic.jpg"),
      asset("/lpk-light-beams.jpg"),
    ],
    badge: "Iconic",
    specs: [
  ...
  },
  {
    ...
    price: 3000,
    priceUnit: "couple",
    image: asset("/sinq-pool-party.jpg"),
    gallery: [
      asset("/sinq-pool-night.jpg"),
      asset("/sinq-poolside-lounge.jpg"),
      asset("/nightlife-sinq.jpg"),
      asset("/sinq-club-dynamic.jpg"),
      asset("/sinq-light-beams.jpg"),
    ],
    badge: "Popular",
    specs: [
      { label: "Couple entry", value: "₹3,000 (fully redeemable as cover)" },
