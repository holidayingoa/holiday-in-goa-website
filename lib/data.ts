...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    price: 0,
    priceOnRequest: true,
    image: img("photo-1516815231560-8f41ec531527"),
    badge: "Private Tour",
    description:
  ...
  },
  {
    ...
    duration: "Night (9:00 PM onwards)",
    rating: 4.6,
    reviews: 176,
    price: 3000,
    strikePrice: 4000,
    ...
    badge: "Luxury",
    description:
      "Party at one of North Goa's most extravagant nightclubs — Hammerzz on the Calangute–Baga road. Expect a huge dance floor, world-class sound and lighting, EDM and hip-hop sets by top DJs, a rooftop bar and an electric, dressed-up crowd. Doors open 9:00 PM, party from 10:00 PM.",
    highlights: [
      "Entry to Hammerzz luxury nightclub",
  ...
  },
  {
    ...
    duration: "Night (9:30 PM – 3:30 AM)",
    rating: 4.5,
    reviews: 158,
    price: 1500,
    strikePrice: 2500,
    ...
    badge: "Iconic",
    description:
      "Dance the night away at Goa's most striking riverside club — Love Passion Karma. Famous for its rock-carved, mystical architecture on the banks of the Nerul River, LPK blends terracotta sculptures and a huge dance floor with EDM, hip-hop and live sets. Open 9:30 PM to 3:30 AM.",
    highlights: [
      "Entry to the iconic LPK Waterfront",
  ...
  },
  {
    ...
    duration: "Night (9:00 PM – 3:00 AM)",
    rating: 4.4,
    reviews: 149,
    price: 2500,
    strikePrice: 3000,
    ...
    badge: "Popular",
    description:
      "Party at SinQ — Goa's original party resort in Candolim, near Fort Aguada. A one-stop night out with a buzzing nightclub, lounge, Goan tavern and poolside deck, top DJs and a fashionable crowd. Open daily 9:00 PM to 3:00 AM.",
    highlights: [
      "Entry to SinQ nightclub (couple/stag)",
    ...
    inclusions: [
      "Club entry (couple/stag)",
      "Cover charge redeemable on drinks",
